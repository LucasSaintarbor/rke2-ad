...
. You can continue to add new server and worker nodes to cluster per standard link:install/ha.adoc#3-launch-additional-server-nodes[RKE2 HA installation documentation].
