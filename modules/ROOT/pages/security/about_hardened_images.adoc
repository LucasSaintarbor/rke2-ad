...
* Any binaries that are written in Go are compiled using a FIPS 140-2 compliant build process. For more information on this compiler, refer link:../security/fips_support.adoc#use-of-fips-compatible-go-compiler[here].
