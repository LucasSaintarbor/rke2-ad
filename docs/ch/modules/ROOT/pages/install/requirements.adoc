...
.重要提示
====
如果你的节点安装并启用了 NetworkManager，请link:../known_issues.adoc#networkmanager[确保将其配置为忽略 CNI 管理的接口]。如果你的节点安装并启用了 Wicked，请link:../known_issues.adoc#wicked[确保转发 sysctl 配置已启用]。
====
